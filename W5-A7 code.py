"""Since "age" is a private attribute, it cannot be accessed directly from outside the class. 
It must be accessed through a public getter method. This was resolved by implementing 
...
class Person:
    def __init__(self, name, address, age):
        ...
        # Was Private attribute - changed to protected
        self._age = age
    ...
    # Public getter for private attribute - changed to protected
    def get_age(self):
        return self._age
...
if __name__ == "__main__":
    ...
    # Private access (will cause error) - changed to protected
    print(s1._age)
